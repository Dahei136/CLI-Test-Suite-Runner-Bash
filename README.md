...
# Bash Test Suite Runner A lightweight, reusable Bash script for automating regression testing of command-line programs. Given a suite file listing test stems and a target program, the script runs each test, compares the actual output with the expected output, and reports any failures in a structured, human-readable format. 
...
- ## Usage ```bash ./runSuite.sh suite-file program
- **example**:
